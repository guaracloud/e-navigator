...
| Self-observability | Source accounting logs and warnings; Prometheus signal rendering; native controller readiness/freshness/relist/watch/reconciliation/cgroup metrics; native exporter queue/retry/circuit/drop metrics | Unit, registry integration, and selected logs | unified source/attachment health plus protocol/TLS/profile/process metrics | alert and failure-injection proof | health | every induced blind spot changes a documented native metric/health state |

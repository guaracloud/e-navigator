...
- Do not claim production OTLP, pprof, external profile backend, exporter retry, exporter batching, or exporter storage behavior until real exporters and integration tests exist.

...
- bounded DNS request parsing with configurable packet and diagnostic preview
  ...
  Kafka request-header plus bounded ApiVersions, non-flexible AlterConfigs, AlterReplicaLogDirs, flexible WriteTxnMarkers, non-flexible AddOffsetsToTxn, AddPartitionsToTxn,
  ...
  flexible WriteTxnMarkers and non-flexible AddOffsetsToTxn, AddPartitionsToTxn, AlterConfigs, AlterReplicaLogDirs, CreateAcls, CreatePartitions, CreateTopics, DeleteAcls, DeleteRecords, DeleteTopics, DeleteGroups, DescribeAcls, DescribeConfigs, DescribeGroups,
...
- **Kafka protocol observability:** bounded request-header parsing for common
  ...
  Produce, Fetch, AddOffsetsToTxn, AddPartitionsToTxn, AlterConfigs, AlterReplicaLogDirs, CreateAcls, CreatePartitions, CreateTopics, DeleteAcls, DeleteRecords, DeleteTopics, DeleteGroups, DescribeAcls, DescribeConfigs, DescribeGroups, EndTxn,
  ...
  AddPartitionsToTxn, AlterConfigs, AlterReplicaLogDirs, CreateAcls, CreatePartitions, CreateTopics, DeleteAcls, DeleteRecords, DeleteTopics, DeleteGroups, DescribeAcls, DescribeConfigs, DescribeGroups, EndTxn, Fetch, FindCoordinator, Heartbeat,
  InitProducerId, JoinGroup, LeaveGroup, ListGroups, ListOffsets, Metadata, OffsetCommit,

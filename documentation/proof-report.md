...
- bounded DNS request parsing with configurable packet and diagnostic preview
  ...
  CreatePartitions, CreateTopics, DeleteRecords, DeleteTopics, DescribeGroups, DeleteGroups, EndTxn, FindCoordinator, Heartbeat,
  ...
  flexible WriteTxnMarkers and non-flexible AddOffsetsToTxn, AddPartitionsToTxn, CreatePartitions, CreateTopics, DeleteRecords, DeleteTopics, DeleteGroups, DescribeGroups,
...
- **Kafka protocol observability:** bounded request-header parsing for common
  ...
  Produce, Fetch, AddOffsetsToTxn, AddPartitionsToTxn, CreatePartitions, CreateTopics, DeleteRecords, DeleteTopics, DeleteGroups, DescribeGroups, EndTxn,
  ...
  AddPartitionsToTxn, CreatePartitions, CreateTopics, DeleteRecords, DeleteTopics, DeleteGroups, DescribeGroups, EndTxn, Fetch, FindCoordinator, Heartbeat,
  InitProducerId, JoinGroup, LeaveGroup, ListGroups, ListOffsets, Metadata, OffsetCommit,

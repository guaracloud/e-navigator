...
- bounded DNS request parsing with configurable packet and diagnostic preview
  ...
  Kafka request-header plus bounded ApiVersions, non-flexible AlterConfigs, AlterReplicaLogDirs, CreateDelegationToken, DescribeDelegationToken, DescribeLogDirs, ElectLeaders, ExpireDelegationToken, RenewDelegationToken, flexible WriteTxnMarkers, non-flexible AddOffsetsToTxn, AddPartitionsToTxn,
...
- **Kafka protocol observability:** bounded request-header parsing for common
  ...
  Produce, Fetch, AddOffsetsToTxn, AddPartitionsToTxn, AlterConfigs, AlterReplicaLogDirs, CreateDelegationToken, DescribeDelegationToken, DescribeLogDirs, ElectLeaders, ExpireDelegationToken, RenewDelegationToken, CreateAcls, CreatePartitions, CreateTopics, DeleteAcls, DeleteRecords, DeleteTopics, DeleteGroups, DescribeAcls, DescribeConfigs, DescribeGroups, EndTxn,

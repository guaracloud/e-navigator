...
- bounded DNS request parsing with configurable packet and diagnostic preview
  ...
  Kafka request-header plus bounded ApiVersions, flexible AlterPartitionReassignments, AlterUserScramCredentials, DescribeQuorum, DescribeUserScramCredentials, ListPartitionReassignments, and WriteTxnMarkers, flexible/non-flexible AlterClientQuotas, DescribeClientQuotas, and IncrementalAlterConfigs, non-flexible AlterConfigs, AlterReplicaLogDirs, CreateDelegationToken, DescribeDelegationToken, DescribeLogDirs, ElectLeaders, ExpireDelegationToken, RenewDelegationToken, AddOffsetsToTxn, AddPartitionsToTxn,
...
- **Kafka protocol observability:** bounded request-header parsing for common
  API keys, bounded ApiVersions request-body validation, bounded flexible AlterPartitionReassignments, AlterUserScramCredentials, DescribeQuorum, DescribeUserScramCredentials, ListPartitionReassignments, and WriteTxnMarkers, flexible/non-flexible

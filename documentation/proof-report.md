...
- bounded DNS request parsing with configurable packet and diagnostic preview
  ...
  Heartbeat, LeaveGroup, ListOffsets, and Metadata request bodies, ApiVersions
  response, bounded Produce request/response, and bounded non-flexible Fetch,
  FindCoordinator, Heartbeat, LeaveGroup, ListOffsets, and Metadata
...
- **Kafka protocol observability:** bounded request-header parsing for common
  ...
  Produce, Fetch, FindCoordinator, Heartbeat, LeaveGroup, ListOffsets, and Metadata
  ...
  coordinator keys, consumer group/member identifiers, software names, topics,

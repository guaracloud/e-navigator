...
- bounded DNS request parsing with configurable packet and diagnostic preview
  ...
  PostgreSQL Query/Parse/Execute/Sync wire-message and
...
- **PostgreSQL protocol observability:** bounded simple Query, Parse, Execute,
  Sync, CommandComplete, ReadyForQuery, and ErrorResponse parsing is locally
  tested without exporting raw SQL text or raw error messages, including canonical

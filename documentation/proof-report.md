...
- bounded DNS request parsing with configurable packet and diagnostic preview
  ...
  Kafka request-header plus bounded ApiVersions, flexible AlterPartitionReassignments, ListPartitionReassignments, and WriteTxnMarkers, flexible/non-flexible DescribeClientQuotas and IncrementalAlterConfigs, non-flexible AlterConfigs, AlterReplicaLogDirs, CreateDelegationToken, DescribeDelegationToken, DescribeLogDirs, ElectLeaders, ExpireDelegationToken, RenewDelegationToken, AddOffsetsToTxn, AddPartitionsToTxn,
...
- **Kafka protocol observability:** bounded request-header parsing for common
  API keys, bounded ApiVersions request-body validation, bounded flexible AlterPartitionReassignments, ListPartitionReassignments, and WriteTxnMarkers, flexible/non-flexible
  DescribeClientQuotas and IncrementalAlterConfigs, and non-flexible Produce, Fetch, AddOffsetsToTxn, AddPartitionsToTxn, AlterConfigs, AlterReplicaLogDirs, CreateDelegationToken, DescribeDelegationToken, DescribeLogDirs, ElectLeaders, ExpireDelegationToken, RenewDelegationToken, CreateAcls, CreatePartitions, CreateTopics, DeleteAcls, DeleteRecords, DeleteTopics, DeleteGroups, DescribeAcls, DescribeConfigs, DescribeGroups, EndTxn,
  ...
  validation, and ApiVersions, Produce, flexible AlterPartitionReassignments, ListPartitionReassignments, and WriteTxnMarkers, flexible/non-flexible DescribeClientQuotas and IncrementalAlterConfigs, and non-flexible AddOffsetsToTxn,

...
- bounded DNS request parsing with configurable packet and diagnostic preview
  ...
  Kafka request-header plus bounded ApiVersions, flexible AlterPartitionReassignments and WriteTxnMarkers, flexible/non-flexible IncrementalAlterConfigs, non-flexible AlterConfigs, AlterReplicaLogDirs, CreateDelegationToken, DescribeDelegationToken, DescribeLogDirs, ElectLeaders, ExpireDelegationToken, RenewDelegationToken, AddOffsetsToTxn, AddPartitionsToTxn,
...
- **Kafka protocol observability:** bounded request-header parsing for common
  API keys, bounded ApiVersions request-body validation, bounded flexible AlterPartitionReassignments and WriteTxnMarkers, flexible/non-flexible
  ...
  validation, and ApiVersions, Produce, flexible AlterPartitionReassignments and WriteTxnMarkers, flexible/non-flexible IncrementalAlterConfigs, and non-flexible AddOffsetsToTxn,

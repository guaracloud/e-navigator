...
- bounded DNS request parsing with configurable packet and diagnostic preview
  ...
  Kafka request-header plus bounded ApiVersions, flexible AlterPartitionReassignments, AlterUserScramCredentials, DescribeCluster, DescribeQuorum, DescribeUserScramCredentials, ListPartitionReassignments, UpdateFeatures, and WriteTxnMarkers, flexible/non-flexible AlterClientQuotas, DescribeClientQuotas, and IncrementalAlterConfigs, non-flexible AlterConfigs, AlterReplicaLogDirs, CreateDelegationToken, DescribeDelegationToken, DescribeLogDirs, ElectLeaders, ExpireDelegationToken, RenewDelegationToken, AddOffsetsToTxn, AddPartitionsToTxn,
  ...
  flexible AlterPartitionReassignments, AlterUserScramCredentials, DescribeCluster, DescribeQuorum, DescribeUserScramCredentials, ListPartitionReassignments, UpdateFeatures, and WriteTxnMarkers, flexible/non-flexible AlterClientQuotas, DescribeClientQuotas, and IncrementalAlterConfigs, and non-flexible AddOffsetsToTxn, AddPartitionsToTxn, AlterConfigs, AlterReplicaLogDirs, CreateDelegationToken, DescribeDelegationToken, DescribeLogDirs, ElectLeaders, ExpireDelegationToken, RenewDelegationToken, CreateAcls, CreatePartitions, CreateTopics, DeleteAcls, DeleteRecords, DeleteTopics, DeleteGroups, DescribeAcls, DescribeConfigs, DescribeGroups,
...
- **Kafka protocol observability:** bounded request-header parsing for common
  API keys, bounded ApiVersions request-body validation, bounded flexible AlterPartitionReassignments, AlterUserScramCredentials, DescribeCluster, DescribeQuorum, DescribeUserScramCredentials, ListPartitionReassignments, UpdateFeatures, and WriteTxnMarkers, flexible/non-flexible

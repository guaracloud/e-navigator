...
The container attribution processor enriches protocol request observations, extracted trace-context observations, request span observations, and request correlation warnings using the existing PID-to-cgroup and Kubernetes metadata cache path. Missing attribution remains non-fatal.

...
- DNS, HTTP/request, MySQL, PostgreSQL, and Redis parsers, trace, and profiling
  foundations;
...
- dependency graph, resource metrics, network metrics, MySQL, PostgreSQL, and
  Redis parser foundations, request/trace/profile foundations, and runtime
  security generator behavior through tests;

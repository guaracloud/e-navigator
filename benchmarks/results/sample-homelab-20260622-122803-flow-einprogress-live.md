# Homelab Sample: E-Navigator Nonblocking Connect Slice

Run: `20260622-122803-flow-einprogress-live`
...
- Tag: `ghcr.io/e-navigator/e-navigator:sha-622e1aa`
...
- Both DaemonSet pods used `ghcr.io/e-navigator/e-navigator@sha256:90b571bf89ac36c1432a503ad9b9add7abd7604579533c1912201568db1d5bfc`
...
- Controlled stdout records had 0 byte-bearing closes, 0 controlled `network_flow_summary` rows, and 0 `network_flow_bytes` JSON signals.
...
- Direct `/metrics` contained no `network_flow_bytes` lines and no controlled-address labels.
...
- Direct or Prometheus `network_flow_bytes` export from controlled live traffic.
